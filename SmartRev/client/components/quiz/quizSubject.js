...
export default function quizSubject({ navigation }) {
    ...
    const openMath = () => {
        navigation.navigate("quizListStudent", { code: mathCode })
    }

    const openPhysics = () => {
        navigation.navigate("quizListStudent", { code: phyCode })
    }

    const openChemistry = () => {
        navigation.navigate("quizListStudent", { code: chemCode })
    }

    const openBiology = () => {
        navigation.navigate("quizListStudent", { code: bioCode })
    }
