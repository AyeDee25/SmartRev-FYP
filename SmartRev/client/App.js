...
import createForumTeacher from './components/forum/createForumTeacher';
import viewForum from './components/forum/viewForum';
import viewForumTeacher from './components/forum/viewForumTeacher';
      ...
      <NativeBaseProvider>
        <NavigationContainer>
          ...
          <Stack.Navigator initialRouteName="Home">
            ...
            <Stack.Screen name="createForumTeacher" component={createForumTeacher} options={{ headerTitle: "Create a Forum", headerTitleAlign: 'center', headerStyle: { backgroundColor: 'orange' } }} />
            <Stack.Screen name="viewForumTeacher" component={viewForumTeacher} options={{ headerTitle: "View Forum", headerTitleAlign: 'center', headerStyle: { backgroundColor: 'orange' } }} />
